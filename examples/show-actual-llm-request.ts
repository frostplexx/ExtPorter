...
const examplePrompt = buildPromptFromFile(templatePath, {
    ...
    manifest_summary: 'Manifest.json: {"name": "Example", "version": "1.0", "permissions": ["tabs"]}',
...
console.log('SOLUTION: Use /api/chat endpoint instead, which separates instructions from content:\n');
...
const chatFormat = {
    ...
    messages: [
        {
            role: "system",
            content: "You are a helpful research assistant which analyzes Chrome browser extensions and generates concise documentation."
        },
        {
            role: "user",
