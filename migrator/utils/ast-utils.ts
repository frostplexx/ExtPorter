...
/**
 * Central AST utilities for the migrator.
 * Consolidates AST traversal and pattern matching utilities used across modules.
 */
 ...
 * 
 * Detects patterns like: chrome.webRequest.{event}.addListener(...)
 *
 * @param node AST node to check
 * @returns True if node is a webRequest event listener
 */
