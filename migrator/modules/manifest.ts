...
export class MigrateManifest implements MigrationModule {
    ...
    public static migrate(extension: Extension): Extension | MigrationError {
        ...
        let resources = extension.manifest["web_accessible_resources"] as string[];
        ...
        let browser_action_obj = extension.manifest["browser_action"];
        let page_action_obj = extension.manifest["page_action"];
        ...
        let background = extension.manifest["background"];
        if (background != undefined) {
            if (background["scripts"] != undefined) {
                ...
                let page = background["page"] as string;
                extension.manifest["background"] = {
                    "service_worker": page
                };
