/**
 * CSP transformation utilities for Manifest V3 compliance
 */
export class cspTransformer {
    /**
     ...
     */
    static makeCSPStringCompliant(csp: string): string {
        ...
        for (const directive of directives) {
            ...
            if (
                ...
                const compliantValues = cspTransformer.filterCompliantValues(
                    directiveValues,
                    allowedValues
                );
