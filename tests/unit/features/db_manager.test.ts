...
describe("Database Manager", () => {
  ...
  describe("Connection Management", () => {
    it("should initialize database connection", async () => {
      ...
      await expect(
        db.insertFoundExtensions(testExtensions),
  ...
  describe("Extension Operations", () => {
    ...
    it("should insert migrated extensions", async () => {
      ...
      await expect(
        db.insertMigratedExtension(migratedExtension),
      ).resolves.not.toThrow();
    });
  ...
  describe("Data Validation", () => {
    it("should validate extension data before insertion", async () => {
      ...
      await expect(
        db.insertFoundExtensions([invalidExtension]),
      ).resolves.not.toThrow();
    });
  });
  ...
  describe("Error Handling", () => {
    it("should handle database operation failures gracefully", async () => {
      ...
      await expect(
        db.insertFoundExtensions([largeExtension]),
      ).resolves.not.toThrow();
    });
  });
